(function(global) {
	...
	function parseBasePath(id) {
		return relapath(data.basePath + '/' + id);
	}
	...
	function resolveScript(){
		...
		for (var i=0; i< scripts.length;i++) {
			...
			if (script && (src = script.getAttribute("src")) && src.indexOf("startUp.js") > -1 && script.getAttribute("data-main")) {
